...
<html lang="en">
    <head>
        ...
        <link href="{{ asset('templatemo/css/templatemo-tiya-golf-club.css') }}" rel="stylesheet">
...
-->
    ...
    <body>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                            <div class="custom-block-image-wrap">
                                <a href="event-detail.html">
                                    <img src="{{ asset('templatemo/images/anna-rosar-ew-olGvgCCs-unsplash.jpg') }}
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="custom-block-image-wrap">
                                <a href="event-detail.html">
                                    <img src="{{ asset('templatemo/images/frederik-rosar-NDSZcCfnsbY-unsplash.jpg') }}" class="custom-block-image img-fluid" alt="">
                    ...
                    <div class="row">
                        ...
                        <div class="row custom-block mb-3">
                            ...
                            <div class="col-lg-4 col-md-8 col-12 order-1 order-lg-0">
                                <div class="custom-block-image-wrap">
                                    <a href="event-detail.html">
                                        <img src="{{ asset('templatemo/images/professional-golf-player.jpg') }}" class="custom-block-image img-fluid" alt="">
                        ...
                        <div class="row custom-block custom-block-bg">
                            ...
                            <div class="col-lg-4 col-md-8 col-12 order-1 order-lg-0">
                                <div class="custom-block-image-wrap">
                                    <a href="event-detail.html">
                                        <img src="{{ asset('templatemo/images/girl-taking-selfie-with-friends-golf-field.jpg') }}" class="custom-block-image img-fluid" alt="">
        ...
        <script src="{{ asset('templatemo/js/bootstrap.bundle.min.js') }}"></script>
